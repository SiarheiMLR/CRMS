...
namespace CRMS.DAL.Migrations
{
    ...
    [Migration("20250817192321_Sync_Attachments")]
    partial class Sync_Attachments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRMS.Domain.Entities.Queue", b =>
                {
                    ...
                    b.HasIndex("CommentAddress");

                    b.HasIndex("CorrespondAddress");
            ...
            modelBuilder.Entity("CRMS.Domain.Entities.Attachment", b =>
                {
                    ...
                    b.HasOne("CRMS.Domain.Entities.User", "UploadedBy")
                        .WithMany()
