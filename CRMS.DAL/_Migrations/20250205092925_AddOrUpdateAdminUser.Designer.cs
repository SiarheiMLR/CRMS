...
namespace CRMS.DAL.Migrations
{
    ...
    [Migration("20250205092925_AddOrUpdateAdminUser")]
    partial class AddOrUpdateAdminUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRMS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccountCreated = new DateTime(2025, 2, 5, 9, 29, 22, 183, DateTimeKind.Utc).AddTicks(5266),
                            City = "Malorita",
                            Company = "BIGFIRM",
                            Country = "Belarus",
                            ...
                            Office = "не указан",
                            PasswordHash = "NvvjmRISlIfiawweQSy/WkfQhPBsYi9+gbA3P9uF+ZA=",
                            PasswordSalt = "Pl+uHAiD+8wWFRzAhU38/A==",
                            PostalCode = "225903",
                            Role = 2,
                            State = "Brest region",
                            Status = 0,
